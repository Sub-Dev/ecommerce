												...
												<tbody>
													...
													<tr class="cart_item">
														<td class="product-name">
															<?php echo htmlspecialchars( $vale["desporduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?> <strong class="product-quantity">× <?php echo htmlspecialchars( $value1["nrqtd"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> 
														</td>
